    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-12 col-lg-3">
                <div>
                    <a href="{{ route('home') }}">
                        <img src="assets/img/logo.png" alt="logo" width="100px"></a>
                </div>
                <p style="color: #fff;">At Brand Boosters USA, we have a team of a highly professional and experienced
                    workforce. Before starting, our strategy is to do in-depth research on new trends, industry
                    knowledge, Statistics, and advanced approaches to drive successful and guaranteed results.</p>
            </div>
            <div class="col-12 col-md-12 col-lg-3">
                <h3>
                    Services
            ...
            <div class="col-12 col-md-12 col-lg-3">
                ...
                <div class="location">
                    ...
                    <a href="#" target="_blank">
                        <address>18 Georgia St, Valley Stream, NY 11580</address>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="footer-end d-flex flex-wrap align-items-center justify-content-between pb-3">
            ...
            <div class="social-inner">
                ...
                <a href="https://www.pinterest.com/brandboostersglobal/" target="_blank">
                    <img src="assets/img/print.png" alt="pinterest">
                </a>
...
<script type="text/javascript">
    ...
    (function() {
        ...
        s1.async = true;
        s1.src = 'https://embed.tawk.to/64ff353d0f2b18434fd7e6a1/1ha2efuqn';
        s1.charset = 'UTF-8';
